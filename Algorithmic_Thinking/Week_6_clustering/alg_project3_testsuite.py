...
def test_hierarchical24():
    ...
    hierdata_24 = [
                    [23, set([('11001', '51013'), ('01073',), ('06059',), ('06037',), ('06029',), ('06071',), ('06075',), ('08031',), ('24510',), ('34013',), ('34039',), ('34017',), ('36061',), ('36005',), ('36047',), ('36059',), ('36081',), ('41051',), ('41067',), ('51840',), ('51760',), ('55079',), ('54009',)])],
    ...
    for num_clusters, expected_county_tuple in hierdata_24:
        ...
        error_message += "\nStudent county tuples:\n" + str(student_county_tuple)+ "\n"
        error_message += "\nExpected county tuples:\n" + str(expected_county_tuple) +"\n"
        suite.run_test(student_county_tuple == expected_county_tuple, True, error_message)

        #print len(student_county_tuple)
        #print len(expected_county_tuple)
...
def test_kmeans():
    ...
    kmeansdata_24 = [
                     [15, 1, set([('34017', '36061'), ('06037',), ('06059',), ('36047',), ('36081',), ('06071', '08031'), ('36059',), ('36005',), ('55079',), ('34013', '34039'), ('06075',), ('01073',), ('06029',), ('41051', '41067'), ('11001', '24510', '51013', '51760', '51840', '54009')])],
