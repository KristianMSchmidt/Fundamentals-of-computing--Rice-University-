...
INITIAL_SPEED = 35  #50 is slow, 35 is standard, 30 is fast
...
def draw(canvas):
    ...
    canvas.draw_text(str(score1)+"/"+str(score2), (200, 40), 40, 'Green')
    ...
    if GAME_IS_ON:
        ...
        canvas.draw_text(message, (200,80),40,"Green")
