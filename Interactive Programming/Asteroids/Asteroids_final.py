...
missile_info = ImageInfo([5,5], [10, 10], 3, 35)   #oprindeligt var lifespan=50
    ...
    for element in group_copy:
        if element.collision(other_object):
            ...
            for explosion in explosion_group:
                print "number of explosions:", len(explosion_group)
                print "expl at", explosion.pos
                print ""
...
def rock_spawner():
    ...
    velocity_constant = 1.4+ 0.8 * math.sqrt((3*score+1)/10)  #higher means faster rocks
