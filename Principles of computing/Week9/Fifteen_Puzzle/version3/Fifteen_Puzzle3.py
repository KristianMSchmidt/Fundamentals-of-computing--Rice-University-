...
class Puzzle:
    ...
    def tree_search(self, move_string, recursion_depth):
        """
    ...
    def solve_puzzle(self, answer_move):
        """
        ...
        #Do tree search in this more general situation:
            ...
            best_score, best_move = self.tree_search("",recursion_depth)
            if best_move == "":
